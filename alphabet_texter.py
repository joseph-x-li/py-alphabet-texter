...
class AlphabetTexter(tk.Frame):
    ...
    def make_internals(self, parent_frame):
        ...
        self.graph = alphabet_graph.AlphabetGraph(parent_frame, figsize=(4.5, 3), dpi=100, interval=150)
        ...
        for i in range(3): self.util_frame.grid_columnconfigure(i, weight=1)
